...
let slider1, slider2, slider3, slider4, slider5,slider6,slider7,slider8,slider9,slider10;
let faceSelector;
...
function draw () {
  ...
  if (mode == '1') {
    // draw 1st face
    let eye_type = int(map(s2, 0, 100, 1, 3));
    let eye_distance = map(s3, 0, 100, 0, 1.5);
    let tail_mode = int(map(s4, 0, 100, 1, 2));
    let facePattern = int(map(s7, 0, 100, 1, 3));
    let eyecolour = int(map(s8, 0, 100, 1, 4));
    let bodyColor = int(map(s9, 0, 100, 1, 10));
    let carpet = int(map(s10, 0, 100, 1, 4));

    let earvalueX = map(s6, 0, 100, 4, 5);
    let earvalueY = map(s6, 0, 100, 9.5, 8);
    let earLineValueX = map(s6, 0, 100, 0, 0.3);
    let earLineValueY = map(s6, 0, 100, 9, 7.6);

    drawFace1(s1,eye_type,eye_distance,tail_mode,s5,eyecolour,earvalueX,
      earvalueY,earLineValueX,earLineValueY,facePattern,bodyColor,carpet);
  }
